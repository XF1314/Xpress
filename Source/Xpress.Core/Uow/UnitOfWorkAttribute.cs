...
namespace Xpress.Core.Uow
{
    ...
    public class UnitOfWorkAttribute : Attribute
    {
        ...
        public virtual void SetOptions(UnitOfWorkOptions unitOfWorkOptions)
        {
            if (IsTransactional.HasValue)
            {
                unitOfWorkOptions.IsTransactional = IsTransactional.Value;
            }
            ...
            {
                unitOfWorkOptions.IsolationLevel = IsolationLevel.Value;
            }
        }
    }
}
