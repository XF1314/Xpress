...
namespace Xpress.Core.Repositories
{
    /// <inheritdoc />
    public abstract class AbsRepositoryBase<TEntity, TIdentity> : IRepository<TEntity, TIdentity>
        where TEntity : class, IEntity<TIdentity>
    {
        #region Select

        /// <inheritdoc />
        public abstract Task<TEntity> GetAsync(TIdentity id);
        /// <inheritdoc />
